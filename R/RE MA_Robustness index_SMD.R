...
source("R/KLD plots_All scenarios.R")    # Panel of KLD.yx plots for all scenarios of one comparison (Makes sense for MA or for one reference-comparison in NMA)



## Load SMD and sd.SMD (Bayesian RE-MA results)
(SMD <- read.table("data/MA-MOD_SMD.txt", head = T)[, 2:3])
